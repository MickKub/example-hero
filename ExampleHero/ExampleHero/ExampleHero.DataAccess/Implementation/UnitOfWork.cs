...
using IDbTransaction = ExampleHero.DataAccess.Abstraction.IDbTransaction;

namespace ExampleHero.DataAccess.Implementation
{
	public sealed class UnitOfWork : IUnitOfWork
	{
		private readonly ExampleHeroDbContext _dbContext;
		private bool _disposed;
		private Dictionary<string, object> _repositories;

		public UnitOfWork(ExampleHeroDbContext dbContext)
		{
